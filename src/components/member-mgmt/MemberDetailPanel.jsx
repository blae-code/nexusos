...
const RANKS = ['PIONEER', 'FOUNDER', 'VOYAGER', 'SCOUT', 'VAGRANT', 'AFFILIATE'];
...
const RANK_COLORS = { PIONEER: '#C8A84B', FOUNDER: '#E8A020', VOYAGER: '#3498DB', SCOUT: '#4A8C5C', VAGRANT: '#E8E4DC', AFFILIATE: '#9A9488' };
