...
function PhaseNode({ label, index, status, canAdvance, onClick }) {
  ...
  const labelColor = isActive ? 'var(--t1)' : isDone ? 'var(--t3)' : 'var(--t3)';
        ...
        >
          {isDone ? (
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M2.5 7L6 10.5L11.5 3.5" stroke="var(--live)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          ) : isActive ? (
  ...
  return (
    <div style={{ overflowX: 'auto' }}>
      <div style={{ display: 'flex', padding: '12px 18px', position: 'relative', minWidth: 'max-content', gap: 10 }}>
        <div style={{ position: 'absolute', top: 30, left: 18, right: 18, height: '0.5px', background: 'var(--b0)', zIndex: 0 }} />
