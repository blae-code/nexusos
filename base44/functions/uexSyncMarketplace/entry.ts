/**
 * uexSyncMarketplace — Manual marketplace refresh with shared lock/cooldown gating.
 */
import { createClientFromRequest } from 'npm:@base44/sdk@0.8.23';
import { runMarketplaceSync } from '../_shared/uexMarket/entry.ts';
...
Deno.serve(async (req) => {
  try {
    ...
    const result = await runMarketplaceSync(base44, {
    ...
    console.error('[uexSyncMarketplace]', message);
