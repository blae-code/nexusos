/**
 * uexSyncRoutes — Rebuild trade routes from cached station-price data.
 */
import { createClientFromRequest } from 'npm:@base44/sdk@0.8.23';
import { runTradeRouteSync } from '../_shared/uexMarket/entry.ts';
...
Deno.serve(async (req) => {
  try {
    ...
    const result = await runTradeRouteSync(base44, {
    ...
    console.error('[uexSyncRoutes]', message);
