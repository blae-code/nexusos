...
Deno.serve(async (req) => {
  try {
    ...
    const secretIds = ['UEX_API_KEY', 'SC_API_KEY', 'SESSION_SIGNING_SECRET', 'AUTH_KEY_HASH_SECRET', 'AUTH_KEY_HASH_FALLBACK_SECRETS', 'SYSTEM_ADMIN_BOOTSTRAP_SECRET', 'APP_URL', 'FLEETYARDS_HANDLE', 'FLEETYARDS_AUTH_COOKIE'];
    const protectedSecrets = ['SESSION_SIGNING_SECRET', 'AUTH_KEY_HASH_SECRET', 'AUTH_KEY_HASH_FALLBACK_SECRETS', 'SYSTEM_ADMIN_BOOTSTRAP_SECRET', 'APP_URL', 'FLEETYARDS_AUTH_COOKIE'];
