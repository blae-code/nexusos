...
- Access Gate (/gate) with star field background and dual-tier auth
- Key Management (/app/admin/keys) — Pioneer+ only, CSPRNG key generation
- Industry Hub (/app/industry) — Materials tab, Blueprints tab with recipe readiness, Queue stub
