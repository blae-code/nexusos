...
- Flow:
  1. Pioneer+ generates a key for the member via Key Management (`/app/admin/keys`)
...
- The old public `resetAdmin` endpoint is removed. Recovery goes through `auth/bootstrap` and the protected bootstrap secret only.
